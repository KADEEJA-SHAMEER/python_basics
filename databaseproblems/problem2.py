...
# my_cursor.execute("create table stud (std_id int auto_increment primary key,std_name varchar(50),course varchar(50),department varchar(50),std_phno bigint,email varchar(50))")
